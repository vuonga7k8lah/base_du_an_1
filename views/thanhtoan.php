                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div
                            ...
                            <nav class="main-menu">
                                <ul>
                                    <li><a href="?act=trang-chu">Home</a>
                                    </li>
                                    <li><a href="?act=san-pham-theo-danh-muc">Shop</a>
                                        <!-- 
                    ...
                    <div class="col">
                        <div class="page-banner text-center">
                            ...
                            <ul class="page-breadcrumb">
                                <li><a href="?act=trang-chu">Home</a></li>
                                <li>Thanh Toán</li>
                            </ul>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-5">
                                                <div class="check-box">
                                                    ...
                                                    <label for="shiping_address">Địa chỉ nhận hàng</label>
                                                </div>
                                            </div>
